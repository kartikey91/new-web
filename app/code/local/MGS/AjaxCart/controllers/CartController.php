    ...
    public function addAction() {
        ...
        try {
            ...
            if (!$cart->getQuote()->getHasError()) {
				...
				$sidebar_lr_cart = $this->getLayout()->createBlock('checkout/cart_sidebar')->setTemplate('checkout/cart/sidebar.phtml')->toHtml();
				...
				$response['sidebar_lr_cart'] = $sidebar_lr_cart;
