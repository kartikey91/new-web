...
class MGS_Megamenu_Block_Vertical extends MGS_Megamenu_Block_Abstract
{
	...
	public function getStaticMenu($item){
		...
		if($item->getStaticContent()!=''){
			$html.= ' <span class="icon-next"><i class="fa fa fa-angle-right"></i></span>';
		}
		$html.='</a>';
		if($item->getStaticContent()!=''){
			...
			$html .= '<div class="megamenu-col megamenu-1col mega-content-wrap have-spetitle level0 " id="mobile-menu-'.$item->getId().$this->getMenuId().'">';
