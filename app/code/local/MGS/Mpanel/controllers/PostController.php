...
class MGS_Mpanel_PostController extends Mage_Core_Controller_Front_Action {
    ...
    public function validateData($data) {
        ...
        switch ($type) {
			...
			// Instagram
            case 'instagram':
                $cmsBlock['content'] = '{{block type="core/template" title="' . $data['setting']['title'] . '" user="' . $data['setting']['user'] . '" number="' . $data['setting']['count'] . '" client="' . $data['setting']['client'] . '" width="' . $data['setting']['width'] . '" height="' . $data['setting']['height'] . '" slider="' . $data['setting']['slider']['active'] . '" ';
