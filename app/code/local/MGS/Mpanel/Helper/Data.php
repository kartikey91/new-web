...
class MGS_Mpanel_Helper_Data extends MGS_Mgscore_Helper_Data {
    ...
    public function getThemeSettings() {
        $setting = array(
            ...
            'breadcrumbs' => Mage::getStoreConfig('mgs_theme/general/breadcrumbs'),
			...
			'sold_label' => Mage::getStoreConfig('mpanel/catalog/sold_label'),
    ...
    public function getProductLabel($product, $new = NULL, $sale = NULL) {
		...
		$soldLabel = Mage::getStoreConfig('mpanel/catalog/sold_label');
		...
		if($soldLabel != ""){
			if (!$stock->getIsInStock()) {
				$html.='<div class="product-label sold-label"><span class="sold">' . $soldLabel . '</span></div>';
			}
		}
        return $html;
    }
    ...
    public function getHeaderColorSetting() {
        $setting = array(
			...
			'.header-v6 .welcome-title span,.header-v6 .welcome-title span.phone' => array(
                'color' => Mage::getStoreConfig('theme_color/header/top_text_color'),
				'border-color' => Mage::getStoreConfig('theme_color/header/top_text_color')
            ),
            '.header-top a,.header-top button' => array(
                'color' => Mage::getStoreConfig('theme_color/header/top_link_color')
            ),
            '.header-top,.header-top .header-social ul li,.header-top .newsletter,.header-top .block-cart-header' => array(
                'border-color' => Mage::getStoreConfig('theme_color/header/top_border_color')
            ),
            '.header-top a:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/header/top_link_hover_color')
            ),
            '.header-top .dropdown-menu' => array(
            ...
            '.header-top .dropdown-menu > li > a' => array(
                'color' => Mage::getStoreConfig('theme_color/header/top_dropdown_link')
            ),
            '.header-top .dropdown-menu > li > a:hover' => array(
            ...
            /* Search Box Style */
            '.header-v1 .form-search .input-text,.header-v1 .form-search .search-select,.header-v1 .form-search .button,.header-v2 .topSearch' => array(
            ...
            '.search-select #select-cat-dropdown li span' => array(
                'color' => Mage::getStoreConfig('theme_color/header/search_link_color')
            ),
            'header .search a:hover,.topsearch-content .btn-search:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/header/search_link_hover_color')
            ),
            '.form-search .input-text,.header-v6 .form-search .input-text' => array(
                'color' => Mage::getStoreConfig('theme_color/header/search_input_color')
            ),
            '.topSearch a,.header-v2 .topSearch a, .header-v4 .topSearch a,.form-search .button,.header-v6 .form-search .button' => array(
                'color' => Mage::getStoreConfig('theme_color/header/search_icon_color')
            ),
            '.search-select #select-cat-dropdown' => array(
            ...
            '.topSearch .topsearch-content' => array(
                'border-color' => Mage::getStoreConfig('theme_color/header/search_dropdown_background')
            ),
            '.form-search .search-select' => array(
                'color' => Mage::getStoreConfig('theme_color/header/search_dropdown_text_color')
            ),
            '.search-select #select-cat-dropdown li span:hover' => array(
            ...
            '.block-cart-header .product-details .product-name a' => array(
            ...
            '.top-bar .newsletter .fa, .block-cart-header .fa-shopping-cart,.top-bar .newsletter' => array(
                'color' => Mage::getStoreConfig('theme_color/header/cart_icon_background')
            ),
            'header .block-cart-header .dropdown-menu' => array(
                'background-color' => Mage::getStoreConfig('theme_color/header/cart_dropdown_background')
            ),
            '.block-cart-header .block-title .count' => array(
            ...
            '#nav_container #mainMenu li a.level0' => array(
                'color' => Mage::getStoreConfig('theme_color/header/menu_link_color')
            ),
            '#nav_container #mainMenu li a.level0:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/header/menu_link_hover_color')
            ),
            '#nav_container #mainMenu li.level0' => array(
                'border-color' => Mage::getStoreConfig('theme_color/header/menu_border_color')
            ),
            '#nav_container #mainMenu ul.dropdown-menu, #nav_container #mainMenu li.dropdown.open a.dropdown-toggle' => array(
                'background-color' => Mage::getStoreConfig('theme_color/header/menu_dropdown_background')
            ),
            '#nav_container #mainMenu li.level0 ul li a' => array(
                'color' => Mage::getStoreConfig('theme_color/header/menu_dropdown_link_color')
            ),
            '#nav_container #mainMenu li.level0 ul li a:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/header/menu_dropdown_link_hover_color')
            ),
			/* Sticky Menu Style */
            '.sticky-menu .sticky-content,.sticky-menu .sticky-content .navbar-collapse' => array(
                'background-color' => Mage::getStoreConfig('theme_color/header/sticky_menu_background')
            ),
            '.sticky-menu .sticky-content #nav_container #mainMenu li a.level0' => array(
                'color' => Mage::getStoreConfig('theme_color/header/sticky_menu_link_color')
            ),
            '.sticky-menu .sticky-content #nav_container #mainMenu li a.level0:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/header/sticky_menu_link_hover_color')
            ),
            '.sticky-menu .sticky-content #nav_container #mainMenu li.level0' => array(
                'border-left-color' => Mage::getStoreConfig('theme_color/header/sticky_menu_border_color')
            ),
			'.sticky-menu .sticky-content #nav_container #mainMenu li.level0:last-child' => array(
				'border-right-color' => Mage::getStoreConfig('theme_color/header/sticky_menu_border_color')
			)
    ...
    public function getFooterColorSetting() {
        $setting = array(
            ...
            'footer .top-footer .social li' => array(
                'border-left-color' => Mage::getStoreConfig('theme_color/footer/top_border_color')
            ),
            'footer .top-footer .social li:last-child,footer .form-subscribe-header' => array(
                'border-right-color' => Mage::getStoreConfig('theme_color/footer/top_border_color')
            ),
            'footer .top-footer a' => array(
                'color' => Mage::getStoreConfig('theme_color/footer/top_link_color')
            ),
            'footer .top-footer a:hover,footer .top-footer a:hover .fa' => array(
                'color' => Mage::getStoreConfig('theme_color/footer/top_link_hover_color')
            ),
            '.top-footer h2,.top-footer h3,.top-footer h4,.top-footer h5,.top-footer h6,footer .form-subscribe-header label' => array(
            ...
            '.middle-footer a,footer .info-footer .block-content a,footer .info-footer .block-content a .fa' => array(
                'color' => Mage::getStoreConfig('theme_color/footer/middle_link_color')
            ),
            '.middle-footer a:hover,footer .info-footer .block-content a:hover,footer .info-footer .block-content a:hover .fa' => array(
                'color' => Mage::getStoreConfig('theme_color/footer/middle_link_hover_color')
            ),
            '.middle-footer h2,.middle-footer h3,.middle-footer h4,.middle-footer h5,.middle-footer h6,footer .block-title .title' => array(
    ...
    public function getMainColorSetting() {
        $setting = array(
            ...
            '.btn-default:hover, .btn-default:focus, .btn-default:active' => array(
			...
			'.top-bar a:hover,.top-bar a:focus,.top-bar button:hover a,.newsletter .block-title:hover,.header-social ul li a:hover,.top-bar .newsletter .actions button,.top-bar .dropdown-menu > li > a:hover,.header-v1 .header-social ul li a:hover,.header-v3 .header-social ul li a:hover,.header-v1 .header-social ul li a:hover,header .form-language:hover button,header  .form-currency:hover button,header  .account-dropdown:hover > a,header  .social-login-options:hover > a,.block-cart-header .price,.block-cart-header .btn-remove,.block-cart-header .btn-edit,.search-select #select-cat-dropdown li span:hover,.topsearch-content .btn-search:hover,.header-v5 .top-bar a:hover,.header-v5 .top-bar a:focus,.header-v9 .top-bar a:hover,.header-v9 .top-bar a:focus,.header-v6 .form-language a:hover,.header-v6 .form-currency a:hover,.header-v6 .account-dropdown a:hover,.header-v6 .social li:hover a,.header-v9 .contact-us .fa,.header-v9 .sticky-content nav ul.nav-main li > a:hover,.header-v9 .sticky-content nav ul.nav-main li > a:focus,.header-v9 .sticky-content nav ul.nav-main li.active > a.level0,header nav ul.nav-main li.active a.level0,header nav ul.nav-main li.active a.level0:hover,header nav ul.nav-main li.active a.level0:focus,.vertical-menu li a:hover,.vertical-menu li:hover a .icon-next,.vertical-menu li.active > a,.vertical-menu li.active > a:hover,.vertical-menu li.active > a:focus,.navbar-collapse ul.nav-main li a:hover,.navbar-collapse ul.nav-main li a:focus,header nav ul.nav-main > li:hover > a,header nav ul.nav-main > li.active > a.level0,header nav ul.nav-main li.dropdown ul.dropdown-menu li ul li > a:hover,.footer-v2 .middle-footer .social li a:hover,.price-box .regular-price .price,.price-box .special-price .price,.sidebar .block.block-cart .product-content .price, .price-box-bundle .price,.price-box .price-from, .price-box .price-to,.price-box .minimal-price .price,.promo-slider .border-lr,.banner-onepage .title-small,.shopping-cart > tr > td > a:hover,.product-content .controls .wl-item .fa-heart,.products-grid .product-content .product-desc .controls .btn-compare:hover,.products-grid .product-content .add-cart-item .btn-cart,.tab-menu.tab-products li > a:hover,.tab-menu.tab-products li.active > a,.service-inline .icon,.products-grid .product-content .product-top .action-quickview .btn-quickview:hover, .widget-latest-post .item .read-more:hover,.number-count .icon,.service-box .icon,.shopping-guides li .icon,.top-toolbar .view-mode a:hover .fa, .top-toolbar .view-mode a:hover,.top-toolbar .view-mode strong, .top-toolbar .view-mode a:hover,.owl-controls .owl-buttons div:hover .fa,.sidebar .block.block-wishlist .product-content .link-cart,.sidebar .block.vertical-menu ul li ul li a:hover,.post-list .postWrapper .latest-post-decs span.comments a:hover,.product-detail .product-info .text-desc a,.social-icons > span .stButton .stLarge:hover:before,body div.light_rounded .pp_close:before,body div.light_rounded .pp_expand:before,body div.light_rounded .pp_contract:before,body div.light_rounded .pp_arrow_previous:before,body div.light_rounded .pp_arrow_next:before,.sidebar .block-related .block-subtitle > a,.contact-info .icon,.product-detail .price-box-bundle .price,.price-box-bundle .fa,.price-box .fa,.social-connected li a:hover,.products-grid .product-content .add-cart-item .text-soul,.product-detail .ratings  > span a:hover,.category-products-list .item .controls .icon-links li button:not(.btn-cart):hover,.category-products-list .item .action-quickview .btn-quickview:hover,.profile-grid .profiles .profile-content:hover .profile-desc .profile-name,.faq-content .panel-group .panel .faq-icon,.chart-parent span,.tab-menu.tab-products.tabs_categories_porfolio li a.is-checked,.tab-menu.tab-products.tabs_categories_porfolio li a:hover,.portfolio-details .portfolio-table tr td a:hover,.catalog-product-view .box-reviews .title-inline .name-review,a:hover, a:focus, .widget-latest-post .item .latest-post-decs .post-info a:hover, .service-box a:hover,.form-language .btn-default:hover,.form-language .btn-default:focus,.form-currency .btn-default:hover,.form-currency .btn-default:focus,.top-bar .open >.dropdown-toggle.btn-default, .electronic .h1, .header-v6 .social li:hover a, .header-v7 .social li:hover a, .cart .price, .checkout-container .price, .checkout-carttable .price' => array(
				'color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			'.form-search .button:hover,.form-search .button:active,.form-search .button:focus,.header-v2 .block-cart-header .block-title .count,.header-v4 .block-cart-header .block-title .count,.header-v2 .navbar-collapse,.header-v5 .block-cart-header .block-title .count,.header-v9 .block-cart-header .block-title .count,.vertical-menu-home .vertical-title,.border-lr.color-red:before,.border-lr.color-red:after,.products-grid .product-content .product-label.sale-label,.category-products-list .product-images-box .product-label.sale-label,.banner-onepage .title-small span:after,.banner-onepage .title-small span:before,.sort-link .fa.select,.sidebar .block-reorder .view-all:hover,.image-media .magnifier .buttons .sf,body a.pp_next:before,body a.pp_previous:before,.onepage-pagination li a:before,.category-products-list .item .controls .icon-links li button.btn-cart,.personal-banner .text-container .btn:hover,.products-grid .product-content .add-cart-item .btn-cart:hover,.top-footer, .cate-best > div:hover, .header-v7 .vertical-menu-content' => array(
				'background-color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			'.header-v9 .contact-us .fa,.vertical-menu-home .vertical-title,.accordion_question.panel-group .panel-collapse .panel-body,.sort-link .fa.select,.sidebar .block-reorder .view-all:hover,.a-tags:hover,.social-icons > span .stButton .stLarge:hover,.product-detail-tabs .nav-tabs li.active a,.product-detail-tabs .nav-tabs li a:hover,.social-connected li a:hover,.onepage-pagination li a.active:before,.faq-content .form-search-faq,.vertical-tabs .nav-tabs li.active a,.vertical-tabs .nav-tabs li:hover a,.personal-banner .text-container .btn:hover' => array(
				'border-color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			'.faq-content .form-search-faq .btn:after' => array(
				'border-right-color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
            '.price-box .regular-price .price,.price-box .special-price .price,.sidebar .block.block-cart .product-content .price, .price-box-bundle .price,.price-box .price-from, .price-box .price-to,.price-box .minimal-price .price' => array(
                'color' => Mage::getStoreConfig('theme_color/main/price_color')
            ),
            'a,.widget-latest-post .item .latest-post-decs .post-info a,.service-box a' => array(
                'color' => Mage::getStoreConfig('theme_color/main/link_color'),
            ),
            'a:hover, a:focus,.widget-latest-post .item .latest-post-decs .post-info a:hover,.service-box a:hover' => array(
    ...
    public function getFrontendHeaderColorSettings() {
        $setting = array(
            'top_header' => array(
				...
				'top_border_color' => array('label' => $this->__('Top border color'), 'value' => Mage::getStoreConfig('theme_color/header/top_border_color')),
            ...
            'top_cart' => array(
                ...
                'cart_icon_background' => array('label' => $this->__('Icon color'), 'value' => Mage::getStoreConfig('theme_color/header/cart_icon_background')),
                'cart_dropdown_background' => array('label' => $this->__('Dropdown background color'), 'value' => Mage::getStoreConfig('theme_color/header/cart_dropdown_background')),
            ...
            'top_menu' => array(
                ...
                'menu_dropdown_background' => array('label' => $this->__('Menu dropdown background'), 'value' => Mage::getStoreConfig('theme_color/header/menu_dropdown_background')),
                'menu_dropdown_link_color' => array('label' => $this->__('Link dropdown color'), 'value' => Mage::getStoreConfig('theme_color/header/menu_dropdown_link_color')),
                'menu_dropdown_link_hover_color' => array('label' => $this->__('Link dropdown hover color'), 'value' => Mage::getStoreConfig('theme_color/header/menu_dropdown_link_hover_color'))
            ),
            'sticky_menu' => array(
                'heading' => $this->__('Sticky Menu'),
                'sticky_menu_background' => array('label' => $this->__('Background color'), 'value' => Mage::getStoreConfig('theme_color/header/sticky_menu_background')),
                'sticky_menu_link_color' => array('label' => $this->__('Link color'), 'value' => Mage::getStoreConfig('theme_color/header/sticky_menu_link_color')),
                'sticky_menu_link_hover_color' => array('label' => $this->__('Link hover color'), 'value' => Mage::getStoreConfig('theme_color/header/sticky_menu_link_hover_color')),
                'sticky_menu_border_color' => array('label' => $this->__('Border color'), 'value' => Mage::getStoreConfig('theme_color/header/sticky_menu_border_color'))
            )
        );
        return $setting;
    }
    ...
    public function getLinksFont() {
        ...
        foreach ($fonts as $_font) {
            if ($isSecure) {
                $links .= '<link href="https://fonts.googleapis.com/css?family=' . $_font . ':400,300,300italic,400italic,700,700italic,900,900italic" rel="stylesheet" type="text/css"/>';
            } else {
